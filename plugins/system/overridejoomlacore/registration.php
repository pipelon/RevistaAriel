...
class UsersModelRegistration extends JModelForm
{
	...
	public function activate($token)
	{
		...
		if (($userParams->get('useractivation') == 2) && !$user->getParam('activate', 0))
		{
			...
			//AGREGADO FELIPE ECHEVERRI
			$userProfile = JUserHelper::getProfile( $userId );
			$data['city'] = $userProfile->profile['city'];
			$data['region'] = $userProfile->profile['region'];
			$data['country'] = $userProfile->profile['country'];
			//FIN AGREGADO FELIPE ECHEVERRI
