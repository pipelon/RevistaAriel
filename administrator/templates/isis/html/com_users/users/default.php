    ...
    <?php if (!empty($this->sidebar)) : ?>
        ...
        <?php else : ?>
            ...
            <?php else : ?>
                <table class="table table-striped" id="userList">
                    ...
                    <tbody>
                        ...
                        foreach ($this->items as $i => $item) :
                            //CAMBIOS FELIPE ECHEVERRI
                            $userProfile = JUserHelper::getProfile( $item->id );                 
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <!-- CAMBIOS FELIPE ECHEVERRI -->
                                <td class="break-word">
                                    <?php echo (isset($userProfile->profile['city'])) ? $this->escape($userProfile->profile['city']) : '-'; ?>
                                </td>
                                <td class="break-word">
                                    <?php echo (isset($userProfile->profile['region'])) ? $this->escape($userProfile->profile['region']) : '-'; ?>
                                </td>
                                <td class="break-word">
                                    <?php echo (isset($userProfile->profile['country'])) ? $this->escape($userProfile->profile['country']) : '-'; ?>
                                </td>
                                <!-- FIN CAMBIOS FELIPE ECHEVERRI -->
                                <td class="center">
                                    <?php if ($canChange) : ?>
                ...
                <?php
                if ($loggeduser->authorise('core.create', 'com_users') && $loggeduser->authorise('core.edit', 'com_users') && $loggeduser->authorise('core.edit.state', 'com_users')) :
                    ?>
                    <?php
                    echo JHtml::_(
