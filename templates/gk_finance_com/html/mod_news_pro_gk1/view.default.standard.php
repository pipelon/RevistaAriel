...
<?php if($news_amount > 0) : ?>
	...
	<div class="gk_npro_mainwrap clearfix<?php if($this->config['autoanim'] == TRUE) echo ' autoanim'; ?>" id="gk_npro-<?php echo $this->config['module_unique_id']; ?>" style="width: <?php echo $block_width; ?>;">
		...
		<?php if($this->config['show_list'] == 1 && count($news_list_tab) > 0) : ?>
		<div class="gk_npro_short" style="width: <?php echo $list_width; ?>;float: <?php echo $module_float; ?>;">
			...
			<div class="gk_npro_short_interface">
				...
				<div class="gk_npro_short_next">&#x25ba;</div>
				<div class="gk_npro_short_prev">&#x25c4;</div>
			</div>
