...
class NSP_GK5_com_content_View extends NSP_GK5_View {
    ...
    static function originalImage($config, $item) {
        ...
        if ($config['thumb_image_type'] == 'full' && (isset($images) && isset($images->image_fulltext) && $images->image_fulltext != '')) {
            $IMG_SOURCE = $images->image_fulltext;
        } elseif ($config['thumb_image_type'] == 'intro' && (isset($images) && isset($images->image_intro) && $images->image_intro != '')) {
    ...
    static function getAltText($config, $item) {
        ...
        if ($config['thumb_image_type'] == 'full' && isset($images)) {
            ...
            } else if (isset($images->image_intro_caption) && $images->image_intro_caption != '') {
